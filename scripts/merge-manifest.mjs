...
//
// stepwise ships from two machines (a Mac and a Windows PC) but the Tauri
...
//     --sig-file "path/to/Stepwise.app.tar.gz.sig" \
//     --url "https://github.com/.../v0.3.0/Stepwise.app.tar.gz" \
//     [--notes "Stepwise 0.3.0"]
//
...
const url = args.url;
const notes = args.notes || (version ? `Stepwise ${version}` : undefined);
